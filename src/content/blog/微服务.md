...
![image-20220515182302822](/微服务/image-20220515182302822.png)
...
（图片源自美团技术团队的文章，而美团用的是**基于React的中心路由基座式微前端**）![image-20220515183129271](/微服务/image-20220515183129271.png)
...
- `Single-Spa`虽然实现了自己的一套路由来监听子工程的切换，但是还需要特定的模块管理系统，比如 `systemjs`来辅助，这导致了改造成本和添加一些额外的库，所以美团直接用的是  `React-Router` (`react-router-dom`)
  ...
  ![image-20220515190230968](/微服务/image-20220515190230968.png)
...
![image-20220515174707011](/微服务/image-20220515174707011.png)
